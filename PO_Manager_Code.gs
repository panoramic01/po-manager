...
function doPost(e) {
  try {
    ...
    // Month-end close (Stock_Close.gs)
    else if (action === 'getStockCountSheet')            result = getStockCountSheet(payload);
    else if (action === 'submitPhysicalCount')           result = submitPhysicalCount(payload);
    else if (action === 'getStockCloseReview')           result = getStockCloseReview(payload);
    else if (action === 'confirmStockClose')             result = confirmStockClose(payload);
    else if (action === 'getStockCloseHistory')           result = getStockCloseHistory(payload);
    else if (action === 'getStockPeriodDetail')          result = getStockPeriodDetail(payload);
